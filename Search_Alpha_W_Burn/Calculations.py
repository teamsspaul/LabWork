...
cwd='/home/paul/Documents/LabWork/Burnup'
...
#f.Print("Backward Euler","942390",nt_Back,Back_Time,Nuclides,Atom_Mass,Nuclide_Names)
#f.Print("Backward Euler","551330",nt_Back,Back_Time,Nuclides,Atom_Mass,Nuclide_Names)
#f.Print("Rational Approx ","942390",nt_Rational,Rational_Time,Nuclides,Atom_Mass,Nuclide_Names)
#import sys
#f.Print2(sys.argv[1],nt_Rational,Nuclides,Atom_Mass,Nuclide_Names)
def AllCalcs():
    return(nt_Rational,Nuclides,Atom_Mass,Nuclide_Names)
###################### Time To execute #################

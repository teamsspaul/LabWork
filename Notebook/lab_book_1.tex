...
\item[\done]{Contacted EHS about Waste pickup, but need the PI's username
  ...
  \item{Last time 0.0076 mCi removed, 0.66267 remains}
  \end{enumerate}
\end{todolist}
...
\item[\done]{Start Efficiency Count with Eu-152 Liquid source,
  ...
  background)}
\item{Background corrections for all calculations}
\item{Assuming 10$\mu$l contamination what are D-values}
\item{Make Easy to read power point}
\item{Automate Decay corrections}
\end{todolist}

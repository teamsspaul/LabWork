...
\textbf{Create 4th dilution sample}
\begin{todolist}
\item{- $\boxed{8\ aq}$}
\end{todolist}
\begin{center}
  ...
  (0 M HNO\tsbs{3})\\
  +\\
  100+/-3 $\mu$l of DI water (leftover in glovebox)\\
  =\\
  0.2+/-0.004 ml of $\sim$
...
\end{center}
\begin{todolist}
\item{Let $\boxed{8\ aq\ Chip4}$ Dry}
\item{Stop count of $\boxed{8\ Aq\ Chip3}$ (looked terrible anyway)}
\item{Start count of $\boxed{8\ Aq\ Chip4}$}
  \begin{itemize}

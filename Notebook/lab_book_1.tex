...
\newexperiment{Cycle_X3_round_2_alpha}{Cycle experiment, round 2,
  replicate of 3, ALPHA preparation (also Mass Spec preparation}
...
\item[\done]{Finish Eff count}
  ...
  \end{itemize}
\item[\done]{Start $\boxed{8\ or}$ count}
...
\labday{Wednesday, 15 November 2016}

\experiment{Cycle_X3_round_2}

\begin{todolist}
\item[\done]{Begin count $\boxed{9\ or}$}
\end{todolist}

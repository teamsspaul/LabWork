...
\item{Transfer in small pipettes}
\end{todolist}

\textbf{Perform Dilution and make chips}

\begin{todolist}
\item{Main solution Dilution}
\begin{center}
...
\vspace{0.3cm}
\begin{center}
  20+/-0.2 $\mu$l of $\boxed{8,9,10\ aq\ DilutionII}$ dropped onto
  $\boxed{8\ ChipII}$
\end{center}
\begin{center}
  20+/-0.2 $\mu$l of $\boxed{8,9,10\ aq\ DilutionII}$ dropped onto
...
\item{Make second dilution of each aqueous (ExI)}
  \begin{todolist}
  \item{- $\boxed{8\ aq}$}
  \end{todolist}
  \begin{center}
...
\textbf{Count Alpha Sample}
\begin{todolist}
\item{Start alpha count $\boxed{8\ ChipII}$}
\end{todolist}

\textbf{Combine final aqueous}
\begin{todolist}
\item{Transfer in glovebox $\boxed{8\ aqBIIIC}$,
  $\boxed{9\ aqBIIIC}$,
  $\boxed{10\ aqBIIIC}$,
  $\boxed{8\ aqBIIC}$,
  $\boxed{9\ aqBIIC}$,
  ...
  $\boxed{9\ aqBC}$,
  $\boxed{10\ aqBC}$}
\item{Combine all 8, 9 10 solutions into their respective stream
  in $\boxed{8\ aqB}$, $\boxed{9\ aq}$, and $\boxed{10\ aq}$}
\item{Transfer out $\boxed{8\ aq}$, $\boxed{9\ aq}$, and $\boxed{10\ aq}$}
\item{Start count for $\boxed{8\ aq}$}
\end{todolist}
...
Transfer all samples to twist cap

...
\textbf{Counting}
\begin{todolist}
\item{Stop count for $\boxed{10\ OrBII\ C}$}
\item{Start count for $\boxed{10\ AqB\ C}$ (finish out
back extraction aqueous counts)}
\end{todolist}

\textbf{Prepare for third back extraction}
\begin{todolist}
\item{Transfer into glovebox $\boxed{8\ orBII\ C}$,
...
\begin{todolist}  
\item{Transfer $\boxed{8\ OrBII\ C}$ into $\boxed{8\ OrBII}$}
\item{Transfer $\boxed{9\ OrBII\ C}$ into $\boxed{9\ OrBII}$}
\item{Transfer $\boxed{10\ OrBII\ C}$ into $\boxed{10\ OrBII}$}
\end{todolist}
...
\textbf{Measure volume of organic phases}
\begin{todolist}
\item{Centrifuge $\boxed{8\ OrBII}$, $\boxed{9\ OrBII}$,
  $\boxed{10\ OrBII}$ for 2,500 rpm. 4 minutes to get liquid to
  bottom}
\item{Measure volumes of all organic phases, $\boxed{8\ OrBII}$
...
\item{Add XXX $\mu$l of $\boxed{\rightarrow Bk\ Ex\ Solution}$
  to $\boxed{10\ orBII}$}
\item{Vortex mix $\boxed{8\ orBII}$
  for 15 minutes on pulse mode}
\item{Vortex mix $\boxed{9\ orBII}$ for 15 minutes on pulse mode}
\item{Vortex mix $\boxed{10\ orBII}$ for 15 minutes on pulse mode}
...
\item{Transfer out $\boxed{8\ orBIII\ C}$, $\boxed{8\ aqBIII\ C}$,
...
\item{Radiac wash the above tubes, and store in fumehood behind
  lead - wait to count}
\item{Centrifuge $\boxed{8\ orBIII\ C}$, $\boxed{8\ aqBIII\ C}$,
  $\boxed{9\ orBIII\ C}$, $\boxed{9\ aqBIII\ C}$, $\boxed{10\ orBIII\ C}$,
...
\textbf{Counting}
\begin{todolist}
\item{Stop count $\boxed{10\ AqB\ C}$}
\item{Start count $\boxed{8\ OrBIII\ C}$}
\end{todolist}

...
\begin{todolist}
\item{Stop count $\boxed{9\ OrIII\ C}$ (early morning)}
\item{Start count $\boxed{10\ OrIII\ C}$ (early morning)}
\item{Stop count $\boxed{10\ OrIII\ C}$ (late afternoon)}
\item{Start count $\boxed{8\ OrIV\ C}$ (late afternoon)}
\end{todolist}
...
\begin{todolist}
\item{Stop count $\boxed{8\ OrIV\ C}$ (early morning)}
\item{Start count $\boxed{9\ OrIV\ C}$ (early morning)}
\item{Stop count $\boxed{9\ OrIV\ C}$ (late afternoon)}
\item{Start count $\boxed{10\ OrIV\ C}$ (late afternoon)}
\end{todolist}
...
\labday{Sunday 8, December 2016}

\experiment{Process_X3}

\begin{todolist}
\item{Stop count $\boxed{10\ OrIV\ C}$ (early morning)}
\item{Start count $\boxed{8\ AqIV\ C}$ (early morning)}
\item{Stop count $\boxed{8\ AqIV\ C}$ (noon)}
\item{Start count $\boxed{9\ AqIV\ C}$ (noon)}
\item{Stop count $\boxed{9\ AqIV\ C}$ (afternoon)}
\item{Start count $\boxed{10\ OrIV\ C}$ (afternoon)}
\item{Stop count $\boxed{10\ OrIV\ C}$ (late afternoon)}
\end{todolist}
...
\begin{todolist}
\item{Transfer $\boxed{8\ OrIII\ C}$, $\boxed{9\ OrIII\ C}$,
  $\boxed{10\ OrIII\ C}$,
  $\boxed{8\ AqIII\ C}$, $\boxed{9\ AqIII\ C}$,
  $\boxed{10\ AqIII\ C}$,
  $\boxed{8\ OrIV\ C}$, $\boxed{9\ OrIV\ C}$,
  $\boxed{10\ OrIV\ C}$ into the glove box}
\item{Add $\boxed{8\ AqIII\ C}$ to $\boxed{8\ Mix}$}
\item{Add $\boxed{9\ AqIII\ C}$ to $\boxed{9\ Mix}$}
\item{Add $\boxed{10\ AqIII\ C}$ to $\boxed{10\ Mix}$}
\end{todolist}

Combine all organic...

\begin{todolist}
\item{Add $\boxed{8\ OrIII\ C}$ to $\boxed{8\ Or}$}
\item{Add $\boxed{8\ OrIV\ C}$ to $\boxed{8\ Or}$}
\item{Add $\boxed{9\ OrIII\ C}$ to $\boxed{9\ Or}$}
\item{Add $\boxed{9\ OrIV\ C}$ to $\boxed{9\ Or}$}
\item{Add $\boxed{10\ OrIII\ C}$ to $\boxed{10\ Or}$}
\item{Add $\boxed{10\ OrIV\ C}$ to $\boxed{10\ Or}$}
\end{todolist}

Measure volume of organic

\begin{todolist}
\item{Measure volumes of organics, $\boxed{8\ Or}$
...
\begin{todolist}
\item{Start count $\boxed{8\ Or}$ at 0 cm}
\item{Stop count $\boxed{8\ Or}$ at 0 cm}
\item{Start count $\boxed{9\ Or}$ at 0 cm}
\item{Stop count $\boxed{9\ Or}$ at 0 cm}
\item{Start count $\boxed{10\ Or}$ at 0 cm}
\item{Stop count $\boxed{10\ Or}$ at 0 cm}
\end{todolist}
...
\labday{Monday 8, December 2016}

\experiment{Process_X3}


\begin{todolist}
\item{Back extraction experiment 1}
\item{Count }
\end{todolist}

...
\item[\done]{Start Count $BLAH$ (?? am)}
\item{End Count $BLAH$ Runtime ?? hrs}
\item{Start Count $BLAH$ (?? pm)}
...
\begin{todolist}
\item[\done]{End count $\boxed{9\ aqII}$ Runtime 16.7 hr}
\item[\done]{Start count $\boxed{??}$ (?? am)}
\item{End count $??$ Runtime ?? hrs}
\item{Start Count $??$ (?? pm)}
...
\experiment{56_run}
\begin{todolist}
\item{Measure volumes of $\boxed{56\ aq}$ and $\boxed{56\ or}$}

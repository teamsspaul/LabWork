...
\item[\done]{Prepare and count alpha sample of Stock}
  \begin{itemize}
  \item{Take {\color{red}\st{20} 5/11/2017} 10 $\mu$l of $\boxed{4\ Dilution}$, put onto
...
\end{center}
\begin{center}
  \st{20} 10?+/-0.2 $\mu$l of $\boxed{8,9,10\ aq\ Dilution}$ dropped onto
  $\boxed{9\ Chip}$
\end{center}
\begin{center}
  \st{20} 10?+/-0.2 $\mu$l of $\boxed{8,9,10\ aq\ Dilution}$ dropped onto
...
\labday{Thursday February 9, 2017}
...
\item[\done]{Organic Totals Make chips}
  ...
  \vspace{0.3cm}
  \begin{center}
    \st{10}6.5+/-0.12 $\mu$l of $\boxed{8\ Org\ Tot\ Dilution}$ dropped onto
  ...
  \vspace{0.3cm}
  \begin{center}
    \st{10}7.5+/-0.12 $\mu$l of $\boxed{9\ Org\ Tot\ Dilution}$ dropped onto
...
\labday{Friday February 10, 2017}
...
\labday{Saturday February 11, 2017}
...
\labday{Sunday February 12, 2017}
...
\labday{Monday February 13, 2017}
...
\labday{Tuesday February 14, 2017}
...
\labday{Wednesday February 15, 2017}
...
\labday{Thursday February 16, 2017}
...
\labday{Friday February 17, 2017}
...
\labday{Saturday February 18, 2017}
...
\labday{Sunday February 19, 2017}
...
\labday{Monday February 20, 2017}
...
\labday{Tuesday February 21, 2017}
...
\labday{Wednesday February 22, 2017}
...
\labday{Saturday February 25, 2017}
...
\labday{Sunday February 26, 2017}
...
\experiment{CHEMLAB}
\begin{todolist}
\item[\done]{Do the prelab for next week's lab (due tomorrow night)}
\end{todolist}
...
\begin{itemize}
\item{Move Safe - Done}
\item{Jeremy is giving 16 lectures - cool!}
\item{Matt Swinny, Cladio, James Miller, Jeremy Osborne, Dr. Marianno, all have gone to India}
\item{Kevin needs 160 mg UO\tsbs{2} per experiment?}
\item{Lois Ortea FCML for Kevin}
\item{Paper metric, number of papers y axis, citations x axis}
\vspace{2cm}
\end{itemize}
\textbf{Todo this upcoming week}
\begin{todolist}
...
\item{Do calculations to show methodology is working}
  \begin{itemize}
  \item{Collect isotopes for 10 nuclides, to produce Cs137, and Nd148, plot as a function
    of burnup}
  \item{X-sections from IAEA, another student, Pyne probably can do it}
  \item{Don't let perfect be the enemy of good}
  \end{itemize}
\vspace{2cm}
\end{todolist}
...
\textbf{Counting}
\begin{todolist}
\item[\done]{Stop alpha count $\boxed{9\ Ex3\ DF=100\ \mu l=10}$}
\item[\done]{Start alpha count $\boxed{10\ Ex3\ DF=100\ \mu l=10}$}
\end{todolist}

\experiment{Grad}
\begin{todolist}
\item[\done]{Get Dr. McDeavitt's signature}
...
\textbf{Counting}
\begin{todolist}
\item[\done]{Stop alpha count $\boxed{10\ Ex3\ DF=100\ \mu l=10}$}
\item[\done]{Start alpha count $\boxed{8\ Ex4\ DF=100\ \mu l=10}$}
\end{todolist}

\experiment{Grad}
\textbf{Things to do}
\begin{todolist}
\item[\done]{Update proposal per Dr. Folden's comments}
\item[\done]{Update written portion of the exam per everyone's concern}
\end{todolist}
...
\textbf{For the people}
\begin{todolist}
\item[\done]{Get water for the people}
\end{todolist}

\experiment{CHEMLAB}
\begin{todolist}
\item[\done]{Write Procedures for next weeks lab}
\item{Grade students papers}
\end{todolist}
...
\textbf{Counting}
\begin{todolist}
\item[\done]{Stop alpha count $\boxed{8\ Ex4\ DF=100\ \mu l=10}$}
\item[\done]{Start alpha count $\boxed{9\ Ex4\ DF=100\ \mu l=10}$}
\end{todolist}
...
\textbf{Counting}
\begin{todolist}
\item[\done]{Stop alpha count $\boxed{9\ Ex4\ DF=100\ \mu l=10}$}
\item[\done]{Start alpha count $\boxed{10\ Ex4\ DF=100\ \mu l=10}$}
\end{todolist}
...
\labday{Tuesday March 7, 2017}

\experiment{CHEMLAB}
\begin{todolist}
\item[\done]{Teach Two sections of lab}
\end{todolist}

\experiment{Alpha_and_MassSpec}
\textbf{Counting}
\begin{todolist}
\item[\done]{Stop alpha count $\boxed{10\ Ex4\ DF=100\ \mu l=10}$}
\item[\done]{Start alpha count $\boxed{8\ BEx1\ DF=100\ \mu l=10}$}
\end{todolist}
...
\experiment{Grad}
\begin{todolist}
\item{Program with 10 isotopes}
  \begin{itemize}
  \item{Gather X-sections for 10 isotopes}
  \item{Process the 10 isotopes with a thermal flux spectrum}
  \item{Compare to ORIGEN2 processed x-sections}
  \item{Plug into bateman solver - use constant power approximation}
  \item{Plot \tss{148}Nd and \tss{137}Cs as a function of burnup}
  \end{itemize}
\end{todolist}
...
\textbf{Counting}
\begin{todolist}
\item{Stop alpha count $\boxed{8\ BEx1\ DF=100\ \mu l=10}$}
\item{Start alpha count $\boxed{9\ BEx1\ DF=100\ \mu l=10}$}
\end{todolist}
...
\textbf{Prepare for Research meeting}
\begin{itemize}
\item{Got program up and running}
\end{itemize}
\textbf{Notes}
\begin{itemize}
\item{Note}
...
\textbf{Todo this upcoming week}
\begin{todolist}
\item{More alpha counts - 7 more}
\item{Write Disseration}
\item{Program stuff}
\item{Grade a mountain of papers}
\vspace{2cm}
\end{todolist}
...
\textbf{Counting}
\begin{todolist}
\item{Stop alpha count $\boxed{9\ BEx1\ DF=100\ \mu l=10}$}
\item{Start alpha count $\boxed{10\ BEx1\ DF=100\ \mu l=10}$}
\end{todolist}

\experiment{Grad}
\begin{todolist}
\item{Get stuff working for disseratation}
\end{todolist}
...
\labday{Friday March 10, 2017}

\experiment{CHEMLAB}
\textbf{Grading}
\begin{todolist}
\item{Grade all the papers}
\end{todolist}

\experiment{Alpha_and_MassSpec}
\textbf{Counting}
\begin{todolist}
\item{Stop alpha count $\boxed{10\ BEx1\ DF=100\ \mu l=10}$}
\item{Start alpha count $\boxed{8\ BEx2\ DF=100\ \mu l=10}$}
\end{todolist}

\experiment{Grad}
\begin{todolist}
\item{Sorry Need to grade}
\end{todolist}
...
\textbf{Counting}
\begin{todolist}
\item{Stop alpha count $\boxed{8\ BEx2\ DF=100\ \mu l=10}$}
\item{Start alpha count $\boxed{9\ BEx2\ DF=100\ \mu l=10}$}
\end{todolist}
...
\labday{Sunday March 12, 2017}

\experiment{Random}
\begin{todolist}
\item{Write out these notes for next week}
\end{todolist}

...
\item{Stop alpha count $\boxed{10\ ChipII}$}
\item{Start alpha count $\boxed{8\ Aq\ ChipII}$}
...
Modified alpha spec program to calculate Cm.
Analyzed magic concentration for Pu.

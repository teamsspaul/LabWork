...
\experiment{Grad}
\begin{todolist}
\item{Prepare something for Matthew Swinney afternoon meeting in Dr. Chirayath's office}
\item{Lots of meetings with Matthew Swinney to INMM, round table}
\end{todolist}

\experiment{Alpha_and_MassSpec}
\textbf{Counting}
\begin{todolist}
\item{Stop alpha count $\boxed{8\ Tot\ Or}$}
\item{Start alpha count $\boxed{9\ Tot\ Or}$}
\end{todolist}
...
\begin{todolist}
\item{Office Hours}
\item{Change office hours for next week}
\item{Get data to students}
\item{Grade last week's reports}
\end{todolist}
...
\experiment{CHEMLAB}
\begin{todolist}
\item{Teach Two sections of CHEM Lab}
...
\textbf{Counting}
\begin{todolist}
\item{Stop alpha count $\boxed{9\ Tot\ Or}$}
\item{Start alpha count $\boxed{10\ Tot\ Or}$}
\end{todolist}
...
\experiment{CHEMLAB}
\begin{todolist}
\item{Finish prelab for next week}
\end{todolist}
...
\textbf{Counting}
\begin{todolist}
\item{Stop alpha count $\boxed{10\ Tot\ Or}$}
\item{Start alpha count $\boxed{???}$}
\end{todolist}
...
\experiment{Grad}
\begin{todolist}
\item{Practice Prelim by myself}
\item{Practice PRelim with Dr. Sunil (10:00am}
\end{todolist}
...
\experiment{Grad}
\begin{todolist}
\item{Practice Prelim by myself (once or twice) Maybe with roommate}
\end{todolist}
...
\labday{Sunday February 24, 2017}

\experiment{Grad}
\begin{todolist}
\item{Practice Practice Practice prelims}
\end{todolist}
...
\labday{Monday February 25, 2017}
...
\experiment{CHEMLAB}
\begin{todolist}
\item{Make up office hours}
\end{todolist}

\textbf{Do nothing else you just did your prelims}

...
\begin{center}
  \begin{tabular}{||c c c c c||}
    \hline
    Series & Aqueous & Organic & Original & Add To\\ [0.5ex]
    \hline\hline
    5 & \hspace{1.5cm} & \hspace{1.5cm} & \hspace{1.5cm} & 1000 ml\\
    \hline
    6 & \hspace{1.5cm} & \hspace{1.5cm} & \hspace{1.5cm} & 1000 ml\\
    \hline
    7 & \hspace{1.5cm} & 450+/-9 & \hspace{1.5cm} & 1000 ml\\
    \hline
  \end{tabular}
\end{center}
\begin{todolist}
...
\end{center}
\begin{todolist}
\item{Count $\boxed{7\ Or}$ 12:00 pm - 3:00 pm}

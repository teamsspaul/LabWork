...
\item[\done]{Discovered (via Kevin) that each alpha sample
  needs to be dilluted by a factor of 10,000 from the
...
=\\
1.0+/-0.006 ml of $\sim$ 0 M HNO\tsbs{3} $\boxed{8\ aqII\ Dillution}$
\end{center}
...
=\\
1.0+/-0.006 ml of $\sim$ 0 M HNO\tsbs{3} $\boxed{9\ aqII\ Dillution}$
\end{center}
...
=\\
1.0+/-0.006 ml of $\sim$ 0 M HNO\tsbs{3} $\boxed{10\ aqII\ Dillution}$
\end{center}
...
=\\
1.0+/-0.006 ml of 30\% TBP $\boxed{8\ orII\ Dillution}$
\end{center}
...
990+/-7.8 $\mu$l of 30\% TBP (leftover in glovebox)\\
=\\
1.0+/-0.006 ml of 30\% TBP $\boxed{9\ orII\ Dillution}$
\end{center}
...
990+/-7.8 $\mu$l of 30\% TBP (leftover in glovebox)\\
=\\
1.0+/-0.006 ml of 30\% TBP $\boxed{10\ orII\ Dillution}$
\end{center}
...
\item{Modified second extraction,
  which had 248 ml for $\boxed{8\ aqII\ C}$}
\item{Make new picture to include making diluted samples}
\end{todolist}
...
change in notebook!
Make new picture to include making diluted samples.
...
\item{Label vials,
  ...
  $\boxed{10\ orIII\ C}$,
  $\boxed{8\ aqIII\ Dillution}$,
  $\boxed{9\ aqIII\ Dillution}$,
  $\boxed{10\ aqIII\ Dillution}$,
  $\boxed{8\ orIII\ Dillution}$,
  $\boxed{9\ orIII\ Dillution}$,
  $\boxed{10\ orIII\ Dillution}$ (smaller 2.5 ml tubes)
...
\item{Transfer:
  ...
  $\boxed{8\ orIII\ Dillution}$,
  $\boxed{9\ orIII\ Dillution}$,
  $\boxed{10\ orIII\ Dillution}$,
  $\boxed{8\ mixIII}$, $\boxed{9\ mixIII}$,
  $\boxed{10\ miIIIx}$.
  (3 clear push caps, and 6 blue push caps
  6 red push caps). Also with 3 15 ml centrifuge tubes (already
  have three in the glovebox)}

\item{Measure volumes of all aqueous phases, $\boxed{8\ aqII}$
...
\end{table}  
\
\item{Add XX $\mu$l of $\boxed{TBP}$ to $\boxed{8\ aqII}$}
\item{Add XX $\mu$l of $\boxed{TBP}$ to $\boxed{9\ aqII}$}
\item{Add XX $\mu$l of $\boxed{TBP}$ to $\boxed{10\ aqII}$}
\item{Vortex mix $\boxed{8\ aqII}$ for 15 minutes on pulse mode}
\item{Vortex mix $\boxed{9\ aqII}$ for 15 minutes on pulse mode}
\item{Vortex mix $\boxed{10\ aqII}$ for 15 minutes on pulse mode}

\item{Centrifuge $\boxed{8\ aqII}$, $\boxed{9\ aqII}$,
  and $\boxed{10\ aqII}$
  with $\boxed{Buddy}$ on 3300 rpm, for 5 minutes}

\item{Pipette with disposable pipette the organic phase
  first, then the aqueous (for all three vials),
  ...
  \begin{itemize}
    \item{notes}\vspace{3cm}
  \end{itemize}
  
\item{Make dilution of each aqueous}
  \begin{todolist}
  \item{- $\boxed{8\ aqIII}$}
  \end{todolist}
  \begin{center}
    ...
    =\\
    1.0+/-0.006 ml of $\sim$
    0 M HNO\tsbs{3} $\boxed{8\ aqIII\ Dillution}$
  \end{center}
  \begin{todolist}
  \item{- $\boxed{9\ aqIII}$}
  \end{todolist}
  \begin{center}
    ...
    =\\
    1.0+/-0.006 ml of $\sim$
    0 M HNO\tsbs{3} $\boxed{9\ aqIII\ Dillution}$
  \end{center}
  \begin{todolist}
  \item{- $\boxed{10\ aqIII}$}
  \end{todolist}
  \begin{center}
    ...
    =\\
    1.0+/-0.006 ml of $\sim$
    0 M HNO\tsbs{3} $\boxed{10\ aqIII\ Dillution}$
  \end{center}
...
\item{Make dilution of each organic phase}
  ...
  \begin{center}
    ...
    990+/-7.8 $\mu$l of 30\% TBP (leftover in glovebox)\\
    =\\
    1.0+/-0.006 ml of 30\% TBP $\boxed{8\ oriII\ Dillution}$
  \end{center}
  \begin{todolist}
  \item{- $\boxed{9\ orIII}$}
  \end{todolist}
  \begin{center}
    ...
    990+/-7.8 $\mu$l of 30\% TBP (leftover in glovebox)\\
    =\\
    1.0+/-0.006 ml of 30\% TBP $\boxed{9\ orIII\ Dillution}$
  \end{center}
  ...
  \begin{center}
    ...
    990+/-7.8 $\mu$l of 30\% TBP (leftover in glovebox)\\
    =\\
    1.0+/-0.006 ml of 30\% TBP $\boxed{10\ orIII\ Dillution}$
  \end{center}
 
\item{Transfer out $\boxed{8\ orIII\ C}$, $\boxed{8\ aqIII\ C}$,
...
\item{Start count $\boxed{8\ aqIII\ C}$ at 26 cm TIME}

...
\item{Stop count $\boxed{8\ OrB\ C}$ at 12:36 am}
\item{Start count $\boxed{9\ OrB\ C}$ at 12:36 am} 
\end{todolist}
...
\textbf{Counting}
\begin{todolist}
\item{Stop count $\boxed{9\ OrB\ C}$ at 12:36 pm}
\item{Start count $\boxed{10\ OrB\ C}$ at 12:36 pm}
\item{Stop count $\boxed{10\ OrB\ C}$ at 12:36 am}
\item{Start count $\boxed{8\ AqB\ C}$ at 12:36 am}
\end{todolist}
...
\textbf{Counting}
\begin{todolist}
\item{Stop count $\boxed{8\ AqB\ C}$ at 8:00 am}
\item{Start count $boxed{9\ AqB\ C}$ at 8:00 am}
\item{Stop count $\boxed{9\ AqB\ C}$ at 4:00 pm}
\item{Start count $\boxed{10\ AqB\ C}$ at 4:00 pm}
\end{todolist}
...
\textbf{Counting}
\begin{todolist}
\item{Stop count $\boxed{10\ AqB\ C}$ at 8:00 am}
\end{todolist}


\textbf{Prepare for second back extraction}
\begin{todolist}
\item{Transfer $\boxed{8\ Or}$, $\boxed{9 \ Or}$, and $\boxed{10\ Or}$
  into glove box}
\item{Transfer into glovebox $\boxed{8\ orB\ C}$, $\boxed{8\ aqB\ C}$,
  $\boxed{9\ orB\ C}$, $\boxed{9\ aqB\ C}$, $\boxed{10\ orB\ C}$,
  $\boxed{10\ aqB\ C}$, in 15 ml centrifuge tubes}
\item{Label vials,
  $\boxed{8\ aqBII}$,
...
\begin{todolist}  
\item{Transfer $\boxed{8\ OrB\ C}$ into $\boxed{8\ OrB}$}
\item{Transfer $\boxed{9\ OrB\ C}$ into $\boxed{9\ OrB}$}
\item{Transfer $\boxed{10\ OrB\ C}$ into $\boxed{10\ OrB}$}
...
\item{Centrifuge $\boxed{8\ OrB}$, $\boxed{9\ OrB}$,
  $\boxed{10\ OrB}$ for 2,500 rpm. 4 minutes to get liquid to
  bottom}
\item{Measure volumes of all organic phases, $\boxed{8\ OrB}$
...
\begin{todolist}
\item{Add XXX $\mu$l of $\boxed{\rightarrow Bk\ Ex\ Solution}$
  to $\boxed{8\ orB}$}
\item{Add XXX $\mu$l of $\boxed{\rightarrow Bk\ Ex\ Solution}$
  to $\boxed{9\ orB}$}
\item{Add XXX $\mu$l of $\boxed{\rightarrow Bk\ Ex\ Solution}$
  to $\boxed{10\ orB}$}
\item{Vortex mix $\boxed{8\ orB}$
  for 15 minutes on pulse mode}
\item{Vortex mix $\boxed{9\ orB}$ for 15 minutes on pulse mode}
\item{Vortex mix $\boxed{10\ orB}$ for 15 minutes on pulse mode}
...
\item{Transfer out $\boxed{8\ orBII\ C}$, $\boxed{8\ aqBII\ C}$,
...
\item{Radiac wash the above tubes, and store in fumehood behind
  lead - wait to count}
\item{Centrifuge $\boxed{8\ orBII\ C}$, $\boxed{8\ aqBII\ C}$,
  $\boxed{9\ orBII\ C}$, $\boxed{9\ aqBII\ C}$, $\boxed{10\ orBII\ C}$,
  $\boxed{10\ aqBII\ C}$, for 2 minutes 4,400 rpm to put all liquid at
  bottom, then parafilm wrap all the vials and store in fumehood.}
\item{Start count $\boxed{8\ OrBII\ C}$} 
\end{todolist}

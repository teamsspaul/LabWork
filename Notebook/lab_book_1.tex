...
\item{Centrifuge $\boxed{8\ aqIII}$, $\boxed{9\ aqIII}$,
  $\boxed{10\ aqIII}$ for 3,300 rpm. 4 minutes to get liquid to
  bottom}
\item{Measure volumes of all aqueous phases, $\boxed{8\ aqIII}$
...
\end{table}  
\
\item{Add XX $\mu$l of $\boxed{TBP}$ to $\boxed{8\ aqIII}$}
\item{Add XX $\mu$l of $\boxed{TBP}$ to $\boxed{9\ aqIII}$}
\item{Add XX $\mu$l of $\boxed{TBP}$ to $\boxed{10\ aqIII}$}
\item{Vortex mix $\boxed{8\ aqIII}$
  for 15 minutes on pulse mode}
\item{Vortex mix $\boxed{9\ aqIII}$ for 15 minutes on pulse mode}
\item{Vortex mix $\boxed{10\ aqIII}$ for 15 minutes on pulse mode}
...
\item{Transfer out $\boxed{8\ orIV\ C}$, $\boxed{8\ aqIV\ C}$,
...
\item{Radiac wash the above tubes, and store in fumehood behind
  lead - wait to count}
\item{Centrifuge $\boxed{8\ orIV\ C}$, $\boxed{8\ aqIV\ C}$,
  $\boxed{9\ orIV\ C}$, $\boxed{9\ aqIV\ C}$, $\boxed{10\ orIV\ C}$,
  $\boxed{10\ aqIV\ C}$, for 2 minutes 4,400 rpm to put all liquid at
  bottom, then parafilm wrap all the vials and store in fumehood.}
\item{Stop count $\boxed{8\ OrIII\ C}$ at TIME pm}
\item{Start count $\boxed{9\ OrIII\ C}$ at TIME pm}
\item{Stop count $\boxed{9\ OrIII\ C}$ at LATE pm}
\item{Start count $\boxed{10\ OrIII\ C}$ at LATE pm (count over night)}

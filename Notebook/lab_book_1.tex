...
\item[\done]{Start count $\boxed{8\ Or}$ at 0 cm around 11:00 am,
  ...
  expected}
\item{Stop count $\boxed{8\ Or}$ at 0 cm (2:20 pm)}
\item{Start count $\boxed{9\ Or}$ at 0 cm (2:20 pm)}
\item{Stop count $\boxed{9\ Or}$ at 0 cm (5:20 pm)}
\item{Start count $\boxed{10\ Or}$ at 0 cm (5:20 pm) - leave over night}
\end{todolist}
...
\item{Transfer:
  ...
  $\boxed{8\ mixB}$, $\boxed{9\ mixB}$,
    $\boxed{10\ mixB}$ with
  (3 clear push caps, and 9 blue push caps
  9 red push caps) into glovebox in large plastic bag}

\item{Remember volumes of organic phases, $\boxed{8\ or}$
...
\begin{todolist}
\item{Add 888 $\mu$l of $\boxed{\rightarrow Bk\ Ex\ Solution}$
  to $\boxed{8\ or}$}
\item{Add 912 $\mu$l of $\boxed{\rightarrow Bk\ Ex\ Solution}$
  to $\boxed{9\ or}$}
\item{Add 863 $\mu$l of $\boxed{\rightarrow Bk\ Ex\ Solution}$
  to $\boxed{10\ or}$}
\item{Vortex mix $\boxed{8\ or}$
  for 15 minutes on pulse mode}
\item{Vortex mix $\boxed{9\ or}$ for 15 minutes on pulse mode}
\item{Vortex mix $\boxed{10\ or}$ for 15 minutes on pulse mode}

\item{Centrifuge $\boxed{8\ or}$, $\boxed{9\ or}$,
  and $\boxed{10\ or}$
  with $\boxed{Buddy}$ on 3300 rpm, for 10 minutes}
...
\item{Transfer out $\boxed{8\ orB\ C}$, $\boxed{8\ aqB\ C}$,
...
\item{Radiac wash the above tubes, and store in fumehood behind
  lead - wait to count}
\item{Centrifuge $\boxed{8\ orB\ C}$, $\boxed{8\ aqB\ C}$,
  $\boxed{9\ orB\ C}$, $\boxed{9\ aqB\ C}$, $\boxed{10\ orB\ C}$,
  $\boxed{10\ aqB\ C}$, for 2 minutes 4,400 rpm to put all liquid at
  bottom, then parafilm wrap all the vials and store in fumehood.}
\item{Start count $\boxed{8\ OrB\ C}$} 
\end{todolist}
...
\labday{Saturday 16, December 2016}

\experiment{Process_X3}

\begin{todolist}
\item{Continue counting?}
\item{Count }
\end{todolist}

...
\item{Transfer $\boxed{closet}$ into glovebox}
\item{-}
\end{todolist}
\begin{center}
    0.149+/-0.011 ml of 15.43+/-0.06 M HNO\tsbs{3} $\boxed{Stock\ HNO_3}$\\
...
\end{todolist}
\begin{center}
Combine 2.500+/-0.025 ml of 4.00+/-0.05 M HNO\tsbs{3} solution.
$\boxed{Stock\ Add}$\\
+\\
0.700+/-0.028 ml of 4.00+/-0.05 M HNO\tsbs{3} solution
$\boxed{Stock}$
\\
=\\
3.2+/-0.038 ml of 4.00+/-0.05 M HNO\tsbs{3} solution.
$\boxed{\rightarrow Stock}$
\end{center}
\begin{todolist}
\item{Transfer $\boxed{closet}$ out of glovebox}
\item{Create $\boxed{Buddy}$ with 4 ml of 4 M HNO\tsbs{3}
     solution}
\item{Create and label vials $\boxed{8}$, $\boxed{9}$,
...
\item{Transfer 0.5 ml of $\boxed{Stock}$ to $\boxed{8}$}
\item{Transfer 0.5 ml of $\boxed{Stock}$ to $\boxed{9}$}
\item{Transfer 0.5 ml of $\boxed{Stock}$ to $\boxed{10}$}
\item{Add scoop of sodium nitrite to $\boxed{8}$}
\item{Add scoop of sodium nitrite to $\boxed{9}$}
\item{Add scoop of sodium nitrite to $\boxed{10}$}
\item{Centrifuged $\boxed{8}$, $\boxed{9}$
  and $\boxed{10}$ to push all solution to
  botttom of vials}
\item{Start count of $\boxed{8}$ noticed bubbles in solution,
  might have to recount - left overnight}
\end{todolist}
